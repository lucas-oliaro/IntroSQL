CREATE TABLE railway.Categorias (
...
CREATE TABLE railway.Proveedores (
...
CREATE TABLE railway.Productos_Proveedores (
...
CREATE TABLE railway.Sucursales (
...
CREATE TABLE railway.Inventario (
...
CREATE TABLE railway.Tipos_Movimientos (
	id_tipo_movimiento INT PRIMARY KEY AUTO_INCREMENT,
    tipo_movimiento VARCHAR(20)
);

CREATE TABLE railway.Ordenes_Compra (
...
CREATE TABLE railway.Detalles_Ordenes_Compra (
...
CREATE TABLE railway.Ordenes_Venta (
...
CREATE TABLE railway.Detalles_Ordenes_Venta (
...
CREATE TABLE railway.Movimientos_Inventario (
...
CREATE TABLE railway.Transportistas (
...
CREATE TABLE railway.Vehiculos (
...
CREATE TABLE railway.Estados_Envio (
